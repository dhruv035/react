...
<p>Lazy loading because those are used only if error happened.</p>
...
<p>Use templates if <code>error.messageTemplate</code> is present.</p>
        ...
        <span class="hljs-keyword">try</span> {
            <span class="hljs-keyword">const</span> templateFilePath = path.resolve(
                __dirname,
                <span class="hljs-string">`../messages/<span class="hljs-subst">${error.messageTemplate}</span>.txt`</span>
            );
...
<p>Use sync API because Node.js should exit at this tick.</p>

        </td>
        <td class="code highlight">
          <pre class="javascript">            <span class="hljs-keyword">const</span> templateText = fs.readFileSync(templateFilePath, <span class="hljs-string">"utf-8"</span>);
            <span class="hljs-keyword">const</span> template = lodash.template(templateText);
